...
/*    .AddAttribute ("BroadcastTreeProtocol", "The broadcast tree protocol that manages this device.",
                   PointerValue (),
                   MakePointerAccessor (&WifiNetDevice::SetBroadcastTreeProtocol,
                                        &WifiNetDevice::GetBroadcastTreeProtocol),
                   MakePointerChecker<BroadcastTreeProtocol> ())
...
//  m_broadcastTreeProtocol == CreateObject<BroadcastTreeProtocol> ();;
...
// BroadcastTreeProtocol seter and geter
/*
void
WifiNetDevice::SetBroadcastTreeProtocol (Ptr<BroadcastTreeProtocol> broadcastTreeProtocol)
{
  m_broadcastTreeProtocol = broadcastTreeProtocol;
  CompleteConfig ();
}


Ptr<BroadcastTreeProtocol>
WifiNetDevice::GetBroadcastTreeProtocol (void) const
{
  return m_broadcastTreeProtocol;
}
*/
...
/***** NEW METHOD TO CHANGE TX POWER OF A WIFI NET DEVICE AT RUN TIME *****/
void 
WifiNetDevice::SetTxPower (double txPower)
{
  m_phy->SetTxPowerStart(txPower);
  m_phy->SetTxPowerEnd(txPower);
