...
//BroadcastTreeProtocolMethods 
 /**
   * \param manager the broadcast tree protocol to use.
   */
//  void SetBroadcastTreeProtocol (Ptr<BroadcastTreeProtocol> BTProtocol);

  /**
   * \returns the broadcast tree protocol we are currently using.
   */
//  Ptr<BroadcastTreeProtocol> GetBroadcastTreeProtocol (void) const;
...
//  Ptr<BroadcastTreeProtocol> m_broadcastTreeProtocol;
